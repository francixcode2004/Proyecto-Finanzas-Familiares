...
Dialog_egresos::Dialog_egresos(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Dialog_egresos)
{
    ui->setupUi(this);
...
Dialog_egresos::~Dialog_egresos()
{
    delete ui;
}

void Dialog_egresos::on_agregarboton_clicked()
{
    // Crear y mostrar el dialogo
    Dialog_aggegre pd(this);
    ...
    Controlador_egresos *m = pd.egresos();
    //Agregar a la tabla
...
void Dialog_egresos::cargar()
{
    ...
    if (archivo.open(QFile::ReadOnly)) {
        ...
        while(!entrada.atEnd()){
            ...
            m_datos.append(datos[MONTO].toFloat());
        }
        archivo.close();
    }
}
...
void Dialog_egresos::on_buttonBox_accepted()
{
...
void Dialog_egresos::on_buttonBox_rejected()
{
    reject();
}

void Dialog_egresos::on_btneliminar_clicked()
{
...
void Dialog_egresos::on_tbtLista_itemClicked(QTableWidgetItem *item)
{
     m_f= item->row();
...
void Dialog_egresos::on_btnmodificar_clicked()
{
...
void Dialog_egresos::on_btnbuscar_clicked()
{
...
double Dialog_egresos::promedio_1()
{
